...
internal enum AudioClientStreamFlags : uint
{
    ...
    ///     A channel matrixer and a sample rate converter are inserted as necessary to convert between the uncompressed format
...
internal enum ProcessLoopbackMode
{
    ...
    ///     Render streams from the specified process and its child processes are included in the activated process loopback
    ///     stream.
    /// </summary>
    ...
    ///     Render streams from the specified process and its child processes are excluded from the activated process loopback
    ///     stream.
    /// </summary>
...
internal enum AudioClientActivationType
{
    ...
    ///     Process loopback activation, allowing for the inclusion or exclusion of audio rendered by the specified process and
    ///     its child processes.
    /// </summary>
    ProcessLoopback
}